    ...
    <c:forEach items="${clueRemarkList}" var="clueRemark">
        <div class="remarkDiv" id="div_${clueRemark.id}" style="height: 60px;">
            ...
            <div style="position: relative; top: -40px; left: 40px;">
                ...
                <b>${clue.fullName}${clue.appellation}-${clue.company}</b> <small style="color: gray;">
                    ${clueRemark.editFlag=='0'? clueRemark.createTime:clueRemark.editTime}
                由${clueRemark.editFlag=='0'? clueRemark.createBy:clueRemark.editBy}${clueRemark.editFlag=='0'? '创建':'修改'}</small>
                <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
                    <a class="myHref" name="editA" clueRemarkId="${clueRemark.id}" href="javascript:void(0);"><span
                            class="glyphicon glyphicon-edit"
                            style="font-size: 20px; color: #E6E6E6;"></span></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a class="myHref" name="deleteA" clueRemarkId="${clueRemark.id}" href="javascript:void(0);"><span
