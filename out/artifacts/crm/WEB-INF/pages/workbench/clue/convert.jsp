                ...
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input type="text" id="searchActivityName" class="form-control" style="width: 300px;"
...
<div id="title" clueId="${clue.id}" class="page-header" style="position: relative; left: 20px;">
